...
GlobalConfig::$CONNECTION_SETTING->DBName = "rent";
...
/** the root url of the application with trailing slash, for example http://localhost/rent/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'rent/';
