...
class AutoMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		...
		{
			self::$FM = Array();
			self::$FM["Placa"] = new FieldMap("Placa","auto","placa",true,FM_TYPE_VARCHAR,20,null,false);
			...
			self::$FM["Estado"] = new FieldMap("Estado","auto","estado",false,FM_TYPE_VARCHAR,20,null,false);
