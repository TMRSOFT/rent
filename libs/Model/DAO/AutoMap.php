...
class AutoMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		...
		{
			self::$FM = Array();
			self::$FM["Placa"] = new FieldMap("Placa","auto","placa",true,FM_TYPE_INT,11,null,false);
			self::$FM["Modelo"] = new FieldMap("Modelo","auto","modelo",false,FM_TYPE_INT,11,null,false);
			...
			self::$FM["Motor"] = new FieldMap("Motor","auto","motor",false,FM_TYPE_INT,11,null,false);
			self::$FM["Color"] = new FieldMap("Color","auto","color",false,FM_TYPE_INT,11,null,false);
			...
			self::$FM["TipoCombustible"] = new FieldMap("TipoCombustible","auto","tipo_combustible",false,FM_TYPE_INT,11,null,false);
			...
			self::$FM["TipoCaja"] = new FieldMap("TipoCaja","auto","tipo_caja",false,FM_TYPE_INT,11,null,false);
