...
class ReservaMap implements IDaoMap, IDaoMap2
{
	...
	public static function GetFieldMaps()
	{
		if (self::$FM == null)
		{
			...
			self::$FM["Fecha"] = new FieldMap("Fecha","reserva","fecha",false,FM_TYPE_DATE,null,null,false);
			...
			self::$FM["Fkauto"] = new FieldMap("Fkauto","reserva","fkauto",false,FM_TYPE_INT,11,null,false);
