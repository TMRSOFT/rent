...
require_once("DAO/TipoAutoCriteriaDAO.php");

/**
 * The TipoAutoCriteria class extends TipoAutoDAOCriteria and is used
 ...
 * @version 1.0
 */
class TipoAutoCriteria extends TipoAutoCriteriaDAO
{
