...
class ReservaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Pkreserva,Fecha,Precio,Fkcliente,Fkauto,Fkempresa'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$reserva->Fecha = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'fecha')));
	...
	public function Update()
	{
		try
		{
			...
			$reserva->Fecha = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'fecha', $reserva->Fecha)));
