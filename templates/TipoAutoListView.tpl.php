...
<h1>
	<i class="icon-th-list"></i> TipoAutos
	...
	<script type="text/template" id="tipoAutoModelTemplate">
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div id="pktipoAutoInputContainer" class="control-group">
					<label class="control-label" for="pktipoAuto">Pktipo Auto</label>
					<div class="controls inline-inputs">
						<span class="input-xlarge uneditable-input" id="pktipoAuto"><%= _.escape(item.get('pktipoAuto') || '') %></span>
	...
	<div class="modal hide fade" id="tipoAutoDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit TipoAuto
